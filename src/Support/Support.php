...
namespace Cuuuuuirz\F2FPay\Support;
...
class Support
{
     ...
     * @throws InvalidConfigException
     */
    public static function generateSign(string $privateKey, array $params): string
    {
    ...
    public static function getHttpResponse(string $requestUrl, array $array)
    {
    	$client = new Client();
